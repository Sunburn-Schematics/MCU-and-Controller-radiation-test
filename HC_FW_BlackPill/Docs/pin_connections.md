...
| `LTC3901_ME_Tmr` | `PB6` and `PB7` | `TIM4_CH1` and `TIM4_CH2` | PWM input capture - measure both frequency and pulse width |
| `LTC3901_MF_Tmr` | `PA15` and `PB3` | `TIM2_CH1` and `TIM2_CH2` | PWM input capture - measure both frequency and pulse width |
| `LT8316_Gate_Tmr` | `PB8` and `PB9` | `TIM4_CH3` and `TIM4_CH4` | PWM input capture - measure both frequency and pulse width |
