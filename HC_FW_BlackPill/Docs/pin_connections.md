...
| `LT8316_Gate_Tmr` | `PB8` | `TIM4_CH3` input capture | Timer input capture - measure low-kHz gate frequency from rising-edge timestamps using the common PWM capture timer tick; duty-cycle capture deferred in the current implementation |
