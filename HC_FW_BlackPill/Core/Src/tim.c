...
/* USER CODE BEGIN 0 */
#define PWM_CAPTURE_TIMER_PRESCALER (7U)
...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM2_MspInit 0 */
    ...
    PA15     ------> TIM2_CH1
    */
    GPIO_InitStruct.Pin = LTC3901_MF_Timer_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(LTC3901_MF_Timer_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_IC_MspInit(TIM_HandleTypeDef* tim_icHandle)
{
  ...
  /* USER CODE END TIM4_MspInit 0 */
    ...
    PB8     ------> TIM4_CH3
    */
    GPIO_InitStruct.Pin = LTC3901_ME_Timer_Pin|LT8316_Gate_Timer_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    ...
    __HAL_LINKDMA(tim_icHandle,hdma[TIM_DMA_ID_CC3],hdma_tim4_ch3);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM3_MspPostInit 0 */
    ...
    PB5     ------> TIM3_CH2
    */
    GPIO_InitStruct.Pin = SDRA_DRV_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM3;
    HAL_GPIO_Init(SDRA_DRV_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = SDRB_DRV_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM3;
    HAL_GPIO_Init(SDRB_DRV_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PA15     ------> TIM2_CH1
    */
    HAL_GPIO_DeInit(LTC3901_MF_Timer_GPIO_Port, LTC3901_MF_Timer_Pin);
...
void HAL_TIM_IC_MspDeInit(TIM_HandleTypeDef* tim_icHandle)
{
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PB8     ------> TIM4_CH3
    */
    HAL_GPIO_DeInit(GPIOB, LTC3901_ME_Timer_Pin|LT8316_Gate_Timer_Pin);
